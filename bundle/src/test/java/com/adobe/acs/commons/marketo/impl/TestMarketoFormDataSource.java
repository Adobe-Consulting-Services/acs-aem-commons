...
public class TestMarketoFormDataSource {
  ...
  public void testdoGet() throws IOException {
    ...
    MarketoClient client = new StaticResponseMarketoClient(new String[] { "/com/adobe/acs/commons/marketo/token-response.json",
        "/com/adobe/acs/commons/marketo/form-response.json", "/com/adobe/acs/commons/marketo/response-noassets.json" });
