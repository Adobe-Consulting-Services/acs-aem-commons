...
public class DynamicTouchUiClientLibraryServletTest {
    ...
    private static final Category LIMIT = new Category("acs-commons.cq-authoring.add-ons.touchui-limit-parsys", "/etc/clientlibs/limit");
    private static final Category PLACEHOLDER = new Category("acs-commons.cq-authoring.add-ons.touchui-parsys-placeholder", "/etc/clientlibs/placeholder");
