...
/**
 * Assert the generation behavior of synthetic dialogs from a java bean --
 * which could be a sling model also.
 * Also try various components and initialization behaviors.
 */
