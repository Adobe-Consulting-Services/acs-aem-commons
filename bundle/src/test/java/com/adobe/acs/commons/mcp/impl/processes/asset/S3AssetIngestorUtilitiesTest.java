...
public class S3AssetIngestorUtilitiesTest {
    ...
    public void testHierarchialElementForFolderNoBasePath() {
        HierarchialElement el = ingestor.new S3HierarchialElement(forKey("folder1/folder2/"));
    ...
    public void testHierarchialElementForFolderWithBasePath() {
        ...
        HierarchialElement el = ingestor.new S3HierarchialElement(forKey("folder1/folder2/folder3/"));
    ...
    public void testHierarchialElementForFileNoBasePath() {
        HierarchialElement el = ingestor.new S3HierarchialElement(forKey("folder1/folder2/image.png"));
    ...
    public void testHierarchialElementForFileWithBasePath() {
        ingestor.s3BasePath = "folder1/";
        HierarchialElement el = ingestor.new S3HierarchialElement(forKey("folder1/folder2/folder3/image.png"));
    ...
    public void testHierarchialElementForFileInRootNoBasePath() {
        HierarchialElement el = ingestor.new S3HierarchialElement(forKey("image.png"));
    ...
    public void testHierarchialElementForFolderInRootNoBasePath() {
        HierarchialElement el = ingestor.new S3HierarchialElement(forKey("folder1/"));
    ...
    public void testHierarchialElementForFileInRootWithBasePath() {
        ingestor.s3BasePath = "folder1/";
        HierarchialElement el = ingestor.new S3HierarchialElement(forKey("folder1/image.png"));
