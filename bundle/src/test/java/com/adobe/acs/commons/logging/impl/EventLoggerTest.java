...
public class EventLoggerTest {
    ...
    public void testConstructMessage() throws JSONException {
        ...
        JSONObject jEmptyProps = new JSONObject(EventLogger.constructMessage(empty));
        ...
        JSONObject jStringProps = new JSONObject(EventLogger.constructMessage(stringEvent));
        ...
        JSONObject jIntProps = new JSONObject(EventLogger.constructMessage(intEvent));
        ...
        JSONObject jBoolProps = new JSONObject(EventLogger.constructMessage(boolEvent));
        ...
        JSONObject jStringArray = new JSONObject(EventLogger.constructMessage(stringArrayEvent));
        ...
        JSONObject jIntArray = new JSONObject(EventLogger.constructMessage(intArrayEvent));
        ...
        JSONObject jMapProps = new JSONObject(EventLogger.constructMessage(mapEvent));
        ...
        JSONObject jStringSet = new JSONObject(EventLogger.constructMessage(stringSetEvent));
