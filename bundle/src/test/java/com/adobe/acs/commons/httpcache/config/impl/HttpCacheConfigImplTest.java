...
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.DEFAULT_AUTHENTICATION_REQUIREMENT;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.DEFAULT_CACHE_STORE;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.DEFAULT_EXPIRY_ON_ACCESS;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.DEFAULT_EXPIRY_ON_CREATE;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.DEFAULT_EXPIRY_ON_UPDATE;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.DEFAULT_FILTER_SCOPE;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.DEFAULT_ORDER;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.FILTER_SCOPE_INCLUDE;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.PROP_AUTHENTICATION_REQUIREMENT;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.PROP_BLACKLISTED_REQUEST_URI_PATTERNS;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.PROP_CACHE_HANDLING_RULES_PID;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.PROP_CACHE_INVALIDATION_PATH_PATTERNS;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.PROP_CACHE_STORE;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.PROP_EXPIRY_ON_ACCESS;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.PROP_EXPIRY_ON_CREATE;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.PROP_EXPIRY_ON_UPDATE;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.PROP_FILTER_SCOPE;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.PROP_ORDER;
import static com.adobe.acs.commons.httpcache.config.impl.HttpCacheConfigImplConfig.PROP_REQUEST_URI_PATTERNS;
