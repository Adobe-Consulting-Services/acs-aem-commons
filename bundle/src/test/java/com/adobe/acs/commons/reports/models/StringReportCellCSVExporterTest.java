...
public class StringReportCellCSVExporterTest {
  ...
  public void testMultiple() throws IllegalAccessException {
    ...
    StringReportCellCSVExporter exporter = new StringReportCellCSVExporter(delimiterConfiguration);
    FieldUtils.writeField(exporter, "property", "multiple", true);
    assertEquals(StringUtils.join(ARRAY_VALUE, delimiterConfiguration.getMultiValueDelimiter()), exporter.getValue(mockResource));
