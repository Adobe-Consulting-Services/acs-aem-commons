...
public class EnsureOakIndex {
    ...
    protected final void activate(Map<String, Object> config) throws RepositoryException {
    	...
    	ScheduledIndexHandling sih = new ScheduledIndexHandling (oakIndexesPath, ensureDefinitionsPath);
    ...
    private class ScheduledIndexHandling implements Runnable {
    	...
    	public ScheduledIndexHandling (String oakIndexPath, String ensureDefinitionsPath) {
