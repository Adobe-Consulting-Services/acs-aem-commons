...
public class SendTemplatedEmailHelper {
	...
	public static Map<String, String> getPayloadProperties(Resource payloadRes,
		...
		if (DamUtil.isAsset(payloadRes)) {
			...
			if (payloadPage != null) {
				Map<String, String> pageContent = getJcrKeyValuePairs(
						payloadPage.getContentResource(), sdf);
			...
			if (authRes != null) {
				...
				if (authorizable != null) {
					...
					if (authorizable.isGroup()) {
						...
						Iterator<Authorizable> memberIt = authGroup
								.getMembers();
						while (memberIt.hasNext()) {
							String currEmail = getAuthorizableEmail(memberIt
									.next());
							if (currEmail != null)
	...
	private static String getAuthorizableEmail(Authorizable authorizable)
			throws RepositoryException {
