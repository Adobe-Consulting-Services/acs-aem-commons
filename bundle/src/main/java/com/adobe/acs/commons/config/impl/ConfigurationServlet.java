...
@Component(label = "ACS AEM Commons - Configuration Servlet", description = "Servlet to render json of configurations having columns key,text,value.", immediate = false, metatype = false)
@Service
@Properties({
