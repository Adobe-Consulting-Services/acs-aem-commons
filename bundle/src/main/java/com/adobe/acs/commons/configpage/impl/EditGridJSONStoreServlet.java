...
@SlingServlet(
        ...
        selectors = { "store" }, extensions = { "json" }, methods = { "GET",
                "POST" }, generateComponent = true)
public class EditGridJSONStoreServlet extends SlingAllMethodsServlet {
        ...
        try {
            ...
            if (gridResource != null) {
                for (Iterator<Resource> iter =
                        resolver.listChildren(gridResource); iter.hasNext();) {
                    iLen++;
    ...
    @Override
    public final void doPost(SlingHttpServletRequest request,
            SlingHttpServletResponse response) throws IOException,
            ServletException {
    ...
    final void writeJsonToResponse(SlingHttpServletResponse response,
    ...
    final boolean update(SlingHttpServletRequest request) {
        boolean success = false;
        try {
    ...
    private List<Map<String, String>> getModifiedRowsFromRequestForUpdate(
        ...
        try {
            ...
            List<Map<String, String>> modifiedRows =
