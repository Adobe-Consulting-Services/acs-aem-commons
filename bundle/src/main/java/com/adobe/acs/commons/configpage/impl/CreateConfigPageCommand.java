...
public class CreateConfigPageCommand implements WCMCommand {
    ...
    @Override
    public final HtmlResponse performCommand(WCMCommandContext commandContext,
        ...
        try {
            ...
            Page page =
                    pageManager.create(parentPath, pageLabel, template,
                            pageTitle);
            ...
            resp =
                    HtmlStatusResponseHelper.createStatusResponse(true,
                            "Page created", page.getPath());
        } catch (WCMException e) {
            log.error("Error during page creation.", e);
            resp =
                    HtmlStatusResponseHelper.createStatusResponse(false,
                            e.getMessage());
