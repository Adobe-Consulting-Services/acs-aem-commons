...
//                    .setLog(Slf4jLog.INSTANCE)
    ...
    /**
     * Map the input path to the "real" REST path
     *
    ...
    public Iterator<Resource> findResources(ResourceResolver resourceResolver, String query, String language) {
        LOG.debug("findResources() ... not yet implemented ... the cool shit of solr ... for every tyrant a tear for the vulnerable");
