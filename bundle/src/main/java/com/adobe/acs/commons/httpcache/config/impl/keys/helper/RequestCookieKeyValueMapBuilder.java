...
/**
 * RequestCookieKeyValueMapBuilder
 * <p>
 * The purpose of the cookie key value map builder is to handle cookiekeyvaluemap instantation.
 * </p>
 */
public class RequestCookieKeyValueMapBuilder {

    private final Set<String> allowedKeys;
    private final Map<String, String> cookieKeyValues;
    private final Set<Cookie> presentCookies;
    private final RequestCookieKeyValueMap keyValueMap = new RequestCookieKeyValueMap();

    public RequestCookieKeyValueMapBuilder(Set<String> allowedKeys, Map<String, String> cookieKeyValues, Set<Cookie> presentCookies) {
    ...
    public RequestCookieKeyValueMap build() {
