...
public interface AutomaticPackageReplicator {
  ...
  /**
   * Loads the legacy configurations from /etc/acs-commons/automatic-package-replication
   * 
   * @return the status
 * @throws LoginException
   */
  @Description("Loads the legacy configurations from /etc/acs-commons/automatic-package-replication")
