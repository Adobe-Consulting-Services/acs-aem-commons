...
import com.adobe.acs.commons.forms.helpers.AbstractFormHelper;
...
@Service(value = AbstractFormHelper.class)
public class AbstractFormHelperImpl implements FormHelper {
    ...
    public String getAction(final Resource resource) {
        return resource.getPath() + "." + FormHelper.SELECTOR + FormHelper.EXTENSION;
    }
    ...
    protected Form getPostForm(final String formName,
        ...
        if(request instanceof SlingHttpServletRequest) {
            log.debug("Attempting to get form [ {} ] from SlingHttpServletRequest", formName);
            ...
            log.debug("Attempting to get form [ {} ] from HttpServletRequest", formName);
