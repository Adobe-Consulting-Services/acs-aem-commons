...
public class JCRHttpCacheStoreImpl extends AbstractJCRCacheMBean<CacheKey, CacheContent> implements HttpCacheStore, JcrCacheMBean, Runnable {
    ...
    // 1 week.
    public static final long         DEFAULT_EXPIRE_TIME_IN_MS = 604800;
    ...
    @Override
    public void put(final CacheKey key, final CacheContent content) {
    ...
    @Override public String getCacheEntry(final String cacheKeyStr) {
        return withSession(session -> {
