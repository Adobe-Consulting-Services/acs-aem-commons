...
public class ComponentDisablerByConfiguration implements EventHandler {

    private static final Logger log = LoggerFactory.getLogger(ComponentDisablerByConfiguration.class);

    // rebind implementation if one with a higher ranking is found
    ...
    @Activate
    protected void activate(Map properties) throws IOException {
