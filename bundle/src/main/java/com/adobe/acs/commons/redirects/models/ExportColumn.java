...
public enum ExportColumn {
    ...
    IGNORE_CASE("Ignore Case", RedirectRule.CASE_INSENSITIVE_PROPERTY_NAME, Boolean.class, true),
    MATCH_TYPE("Match Type", RedirectRule.MATCH_TYPE_PROPERTY_NAME, String.class, true);
