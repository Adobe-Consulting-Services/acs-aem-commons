...
<div ng-controller="MainCtrl" ng-init="init();">
	...
	<div class="coral-Well">
		<form action="/conf/acs-commons/automatic-package-replication" method="post" class="coral-Form--aligned" id="fn-acsCommons-add" ng-submit="createReport($event, 'fn-acsCommons-add')">
			<input type="hidden" name="jcr:primaryType" value="cq:Page" />
			<input type="hidden" name="jcr:content/sling:resourceType" value="acs-commons/components/utilities/automatic-package-replication/automatic-package-replication-item-page" />
			...
			<div class="coral-Form-fieldwrapper">
				...
				<input is="coral-textfield" class="coral-Form-field" placeholder="Enter your title" name="jcr:content/jcr:title" labelledby=title" required /><br/>
<!-- 
				<label class="coral-Form-fieldlabel" id="title">Description</label>
				<textarea is="coral-textarea" class="coral-Form-area" placeholder="Enter your Description" name="jcr:content/jcr:description" labelledby=description" />
 -->				
			</div>
			<div class="coral-Form-fieldwrapper" >
	...
	<table is="coral-table" class="table-example">
		...
		<tbody is="coral-table-body">
			<sling2:findResources query="SELECT * FROM [nt:base] AS s WHERE ISDESCENDANTNODE([/conf/acs-commons/automatic-package-replication]) AND [jcr:primaryType]='cq:Page'" language="JCR-SQL2" var="reports" />
