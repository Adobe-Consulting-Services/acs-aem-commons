...
<div ng-controller="MainCtrl" ng-init="init();">
	...
	<div class="coral-Well">
		<form action="/etc/acs-commons/automatic-package-replication" method="post" class="coral-Form--aligned" id="fn-acsCommons-add" ng-submit="createReport($event, 'fn-acsCommons-add')">
	...
	<table is="coral-table" class="table-example">
		...
		<tbody is="coral-table-body">
			<sling2:findResources query="SELECT * FROM [nt:base] AS s WHERE ISDESCENDANTNODE([/etc/acs-commons/automatic-package-replication]) AND [jcr:primaryType]='cq:Page'" language="JCR-SQL2" var="reports" />
