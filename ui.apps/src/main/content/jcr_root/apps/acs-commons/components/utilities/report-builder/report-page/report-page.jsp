<%--
  ...
  ~ #L%
  --%>
<%@include file="/libs/foundation/global.jsp" %><%@ taglib prefix="wcmmode" uri="http://www.adobe.com/consulting/acs-aem-commons/wcmmode" %><%
            ...
            <div class="page" role="main">
                <div class="content">
                    <div class="content-container">
                        ...
                        <c:if test="${!wcmmode:isEdit(pageContext) and !wcmmode:isDesign(pageContext)}">
                        	<cq:include script="includes/report-body.jsp"/>
                        </c:if>
                    </div>
                </div>
            </div>
