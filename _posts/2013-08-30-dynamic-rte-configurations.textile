...
If you want to alter the configuration, this is done through passing query parameters. If a @fieldLabel@ parameter is passed, the @hideLabel@ option will be automatically removed. See examples below.
...
{% highlight json %}
{
    "jcr:primaryType" : "cq:Widget",
    "xtype" : "slingscriptinclude",
    "script" : "rte.default.text.json.jsp?fieldLabel=Text"
}
{% endhighlight %}


h4. To load the "default" configuration for a field named "text" with a custom stylesheet. Note that in this particular case, the @jsp@ extension is removed from the @script@ value.
{% highlight json %}
{
    "jcr:primaryType" : "cq:Widget",
    "xtype" : "slingscriptinclude",
    "script" : "rte.default.text.json?externalStyleSheets=/etc/clientlibs/myco/source/mine.css"
}
{% endhighlight %}
